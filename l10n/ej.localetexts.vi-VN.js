(function ($, ej, undefined) {
    ...
    $.fn.Locale_viVN = function (pluginName) {
        switch (pluginName) {
            ...
            case "ejExcelFilter":
                ...
                ej.ExcelFilter.Locale["vi-VN"] = {
                    ...
                    True: "thật",
                    False: "sai",
                    AddToFilter: "Thêm lựa chọn hiện tại để lọc"
                };
                break;
            case "ejFileExplorer":
            ...
            case "ejGantt":
                ...
                ej.Gantt.Locale["vi-VN"] = {
                    ...
                    columnHeaderTexts: {
                        ...
                        subTasksStartDate: "Nhiệm vụ phụ Ngày bắt đầu",
                        subTasksEndDate: "Nhiệm vụ phụ Ngày kết thúc",
                        scheduleStartDate: "Lịch trình ngày bắt đầu",
                        scheduleEndDate: "Lịch kết thúc ngày",
                        ...
                        WBS: "WBS",
                        WBSPredecessor: "WBS người tiền nhiệm",
            ...
            case "ejGrid":
                ...
                ej.Grid.Locale["vi-VN"] = {
                    ...
                    NumberMenuOptions: [{ text: "Ít hơn", value: "LessThan" }, { text: "Lớn hơn", value: "GreaterThan" }, { text: "Less Than Hoặc bình đẳng", value: "LessThanOrEqual" }, { text: "Lớn hơn hoặc bằng", value: "GreaterThanOrEqual" }, { text: "bằng", value: "Equal" }, { text: "Không công bằng", value: "NotEqual" }, { text: "Giữa", value: "Between" }],
                    PredicateAnd: "VÀ",
                    PredicateOr: "HOẶC LÀ",
                    Filter: "Lọc",
                    FilterMenuCaption: "Giá trị Lọc",
                    FilterMenuFromCaption: "Từ",
                    FilterMenuToCaption: "Đến",                    
            ...
            case "ejPivotClient":
                ...
                ej.PivotClient.Locale["vi-VN"] = {
                    ...
                    SaveMsg: "Vết lùi đã được lưu thành công!!!",
            ...
            case "ejPdfViewer":
                ...
                ej.PdfViewer.Locale["vi-VN"] = {
                    toolbar: {
                        ...
                        signature: {
                            headerText: 'Chữ ký',
                            contentText: 'Thêm hoặc tạo chữ ký tay.',
        },
        select: {
            headerText: 'Lựa chọn',
            contentText: 'Công cụ lựa chọn cho văn bản.',
        },
        scroll: {
            headerText: 'Panning',
            contentText: 'Nhấp để xoay quanh tài liệu',
        },
    },
                    contextMenu: {
                        copy: {
                    ...
                    signatureWindow: {
                        Signature: {
                            contentText: "Thêm chữ ký"
                        },
                        Add: {
                            contentText: "Thêm vào"
                        },
                        clear: {
        ...
        SummarizeValueBy: "Tóm tắt các giá trị bằng",
        Sum: "Tổng",
        Average: "Trung bình cộng", 
        Count: "Đếm",
        Min: "Tối thiểu",
        Max: "Tối đa",
        DoubleSum: "Tổng gấp đôi", 
        DoubleAverage: "Trung bình gấp đôi", 
        DoubleMin: "Đôi phút",
        DoubleMax: "Nhân đôi tối đa",
        DoubleStandardDeviation: "Độ lệch chuẩn kép",
        DoubleVariance: "Phương sai kép",
        DecimalSum: "Tổng thập phân",
        IntSum: "IntSum",
        CountNumbers: "Đếm số", 
        StdDev: "StdDev",
        StdDevP: "StdDevP",
        ...
        SummaryOf: "Của",     
					...
					EnterFormatName: "Nhập tên định dạng",
            ...
            case "ejReportViewer":
                ...
                ej.ReportViewer.Locale["vi-VN"] = {
                    toolbar: {
                        ...
                        fittopage: {
                            headerText: "Phù hợp để trang",
                            contentText: "Lắp trang báo cáo vào thùng chứa.",
                    ...
                    alertMessage: {
                        close: 'Gần',
                        title: 'Trình xem báo cáo',
                        done: 'được',
                        showDetails: 'Hiển thị chi tiết',
                        hideDetails: 'Ẩn chi tiết',
                        reportLoad: 'Đã tải báo cáo:',
                        RVERR0001: 'Trình xem báo cáo không thể tải Báo cáo',
                        RVERR0002: 'Trình xem báo cáo không thể xử lý Báo cáo',
                        RVERR0003: 'Đã xảy ra lỗi khi trả về dữ liệu ajax',
                        RVERR0004: 'Vui lòng chọn giá trị cho tham số',
                        RVERR0005: 'Tham số {tên người dùng} thiếu giá trị',
                        RVERR0006: 'Vui lòng cung cấp kiểu nhập dữ liệu kiểu thả nổi',
                        RVERR0007: 'Vui lòng nhập kiểu dữ liệu số nguyên',
                        RVERR0008: 'Trình xem báo cáo không thể xác thực thông tin xác thực dữ liệu',
                        ...
                        RVERR0012: 'Giá trị được cung cấp cho tham số báo cáo {tham số} không hợp lệ cho loại của nó.'
                    },
                    selectAll: 'Chọn tất cả',
            ...
            case "ejSchedule":
                ...
                ej.Schedule.Locale["vi-VN"] = {
                    ...
                    RecurrenceEditFollowingEvent: "Các sự kiện sau",
                    ...
                    Editfollowingevent: "Các sự kiện sau",
            ...
            case "ejSpreadsheet":
                ...
                ej.Spreadsheet.Locale["vi-VN"] = {
                    ...
                    FreezeFirstColumn: "Freeze cột đầu tiên",
                    ...
                    ClusteredColumn: "Clustered&nbsp;Cột",
                    StackedColumn: "chồng&nbsp;Cột",
                    ClusteredBar: "Clustered&nbsp;Bar",
                    StackedBar: "Xếpchồng&nbsp;Bar",
                    Radar: "radar",
                    RadarMarkers: "Radar&nbsp;chiều rộng&nbsp;Markers",
                    LineMarkers: "Line&nbsp;chiều rộng&nbsp;Markers",
                    Area: "Khu vực",
                    StackedArea: "Xếp chồng&nbsp;Diệntích",
                    Pie: "bánh",
                    Doughnut: "Bánh rán",
                    Scatter: "Tiêu tan",
                    ...
                    HyperLinkTitle: "Thêm một Hyperlink",
                    ...
                    Save: "Tiết kiệm",
                    SaveFile: "Lưu tệp",
                    HighlightCellRules: "Làm nổi bật quy tắc của Cell",
                    LightRedFillDark: "Ánh sáng Đỏ Đỏ với Đỏ Đỏ Văn bản",
                    YellowFillDark: "Màu vàng Đầy Đen với Văn bản Vàng",
                    GreenFillDark: "Xanh lục Đầy màu xanh lá cây văn bản",
                    RedFill: "Đỏ Điền vào",
                    RedText: "Văn bản Đỏ",
                    Column: "Cột",
                    Bar: "Quán ba",
                    Line: "Hàng",
                    DataValidationType: "Số / Số thập phân / Ngày / Thời gian / Độ dài TextLength / Danh sách",
                    DataValidationAction: "Lớn hơn / lớn hơn hoặc bằng / nhỏ hơn / nhỏ hơn hoặc bằng / bằng / không bằng / giữa / không giữa",
                    Modify:"Chỉnh sửa",
                    Apply:"Ứng dụng",
                    NewCellStyle:"New Cell Style",
                    cellStyleAlert:"Tên phong cách này đã tồn tại",
                    modifyCellStyleAlert:"Tên phong cách này không tồn tại",
                    Color:"Màu",
                    StyleName:"Tên kiểu",
                    LShortdate:"Ngày ngắn",
                    LLongdate:"Ngày dài",
                    Clipboard:"vào clipboard",
                    Font:"phông chữ",
                    Actions:"Hoạt động",
                    Styles:"phong cách",
                    Editing:"chỉnh sửa",
                    ...
                    Tools:"Công cụ",
                    TableStyleOption:"Tùy chọn kiểu bảng",
                    ChartLayouts:"Bố cục bảng xếp hạng",
                    ChartDesignData:"dữ liệu",
                    ChartDesignType:"cấp",
                    ChartDesignSize:"kích thước",
                    Adjust:"điều chỉnh",
                    FormatSize:"kích thước",
            ...
            case "ejTreeGrid":
                ...
                ej.TreeGrid.Locale["vi-VN"] = {
                    ...
                    deleteColumnText: "Bạn có chắc chắn muốn xóa cột này?",
                    deleteRecordText: "Bạn có chắc chắn muốn xóa bản ghi không?",
                    okButtonText: "được",
                    cancelButtonText: "hủy bỏ",
                    confirmDeleteText: "Xác nhận Xóa",
            ...
            case "ejMediaPlayer":
                ...
                ej.MediaPlayer.Locale["vi-VN"] = {
                    ...
                    "RepeatPlaylist": "Phát lại danh sách",
                    "Shuffle": "Xáo trộn",
                    "VideoTitle": "Video",
                    "PlaylistTitle": "Danh sách phát",
                    "PlaylistItemName": "Danh sách mục",
                    "PlaylistItemAuthor": "Tác giả",
