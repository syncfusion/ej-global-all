(function ($, ej, undefined) {
    ...
    $.fn.Locale_ruRU = function (pluginName) {
            ...
            case "ejGantt":
                ...
                ej.Gantt.Locale["ru-RU"] = {
                    ...
                    columnHeaderTexts: {
                        ...
                        subTasksStartDate: "Дата начала подзадач",
                        subTasksEndDate: "Дата окончания подзадач",
        ...
        SummarizeValueBy: "Суммируйте значения по",
        Sum: "сумма",
        Average: "Средний", 
        Count: "подсчитывать",
        Min: "Min",
        Max: "Максимум",
        DoubleSum: "Двойная сумма", 
        DoubleAverage: " Двойное среднее", 
        DoubleMin: "Двойной Мин",
        DoubleMax: "Двойной Макс",
        DoubleStandardDeviation: "Двойное стандартное отклонение",
        DoubleVariance: "Двойная дисперсия",
        DecimalSum: "Десятичная сумма",
        IntSum: "IntSum",
        CountNumbers: "Считать цифры", 
        StdDev: "StdDev",
        StdDevP: "StdDevP",
        Variance: "отклонение",
        VarP: "VarP",
            ...
            case "ejReportViewer":
                ...
                ej.ReportViewer.Locale["ru-RU"] = {
                    ...
                    errorMessage: {
                        ...
                        exportAjaxFailureMsg: 'Невозможно экспортировать документ из-за сбоя подключения службы отчетов.',
                        printAjaxFailureMsg: 'Невозможно распечатать документ из-за сбоя подключения службы отчетов.',
                        reportLoadAjaxFailureMsg: 'Невозможно выполнить действие отчета из-за сбоя подключения службы отчетов.',
                    },
                    progressMessage: {
                        exportLoadingMessage: 'Подготовка к экспорту документа ... Пожалуйста, подождите ...',
                        printLoadingMessage: 'Подготовка данных для печати ... Пожалуйста, подождите ...',
                        printPreparationMessage: 'Подготовка данных для печати ... {0}% выполнено ... Пожалуйста, подождите ...',
                        exportPreparationMessage: 'Подготовка экспорта документа ... {0}% выполнено ... Пожалуйста, подождите ...',
                    },
                    alertMessage: {
                        close: 'Закрыть',
                        title: 'ReportViewer',
                    ...
                    parameterProcessingMessage: 'Загрузка зависимых параметров ...'
                };
                break;
            case "ejRibbon":
